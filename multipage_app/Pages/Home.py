...
def recommend_gen():
    with open('<Location to temp_file.txt file>', 'r') as mov_file:
    ...
    with open('<Location to temp_file.txt file>', "w") as emp_file:
        emp_file.write("")
    ...
    if  mov_str1.startswith("List = ["):
        ...
        for i in range(1,len(names)):
            try:
                ...
                break
# On-Page Personalized recommendation immediately upon signup
else:
    text_1 = """
